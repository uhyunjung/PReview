        ...
        if ((title == "" || content == "")) {
            ...
            db.collection("users").doc(firebase.auth().currentUser.uid).get()
                .then(doc => {
                    ...
                    db.collection("community").doc(params.id).set({
                        ...
                        .then((docRef) => {
                            window.location.href = "/Community_view_detail?board=" + params.board + "&id=" + params.id;
                        })
                        .catch((error) => {
                            alert(error.message);
                        });
...
export default Community_view_edit;
